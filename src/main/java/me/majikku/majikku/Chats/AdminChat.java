...
public class AdminChat implements CommandExecutor {
    ...
    Majikku plugin;
    public AdminChat(Majikku plugin) {this.plugin = plugin;}

    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        if (plugin.getConfig().getBoolean("Updated")) {
            Player p = (Player) sender;
            String admin = plugin.getConfig().getString("Settings." + "Chat." + "adminchat-prefix");
            String color = plugin.getConfig().getString("Settings." + "Chat." + "adminchat-message-color");
