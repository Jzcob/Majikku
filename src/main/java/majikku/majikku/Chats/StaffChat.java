...
public class StaffChat implements CommandExecutor {
    ...
    public StaffChat(Majikku plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        if (this.plugin.getConfig().getBoolean("Updated")) {
            ...
            String staff = this.plugin.getConfig().getString("Settings.Chat.staffchat-prefix");
            String color = this.plugin.getConfig().getString("Settings.Chat.staffchat-message-color");
